...
CatRentalRequest.create!(cat_id: 1, start_date: Date.new(2016,1,1), end_date: Date.new(2017,1,1))
CatRentalRequest.create!(cat_id: 1, start_date: Date.new(2016,6,1), end_date: Date.new(2017,6,1))
